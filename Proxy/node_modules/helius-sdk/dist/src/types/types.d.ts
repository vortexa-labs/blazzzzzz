import type { BlockhashWithExpiryBlockHeight, Cluster, Keypair, SendOptions, SerializeConfig, Signer, SendOptions as SolanaWebJsSendOptions, Transaction, TransactionConfirmationStatus, TransactionError, VersionedTransaction } from '@solana/web3.js';
import type { AccountWebhookEncoding, PriorityLevel, ProgramName, Source, TokenStandard, TransactionContext, TransactionType, TxnStatus, UiTransactionEncoding, WebhookType } from './enums';
...
export type SignedTransactionInput = Transaction | VersionedTransaction | Buffer | string;
